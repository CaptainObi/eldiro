...
fn expr_binding_power(p: &mut Parser, minimum_binding_power: u8) {
    ...
    match p.peek() {
        ...
        // for a binary operator, the minus will not exist as it gets eaten.
        // Unary minus will only occur if a number isn't beforehand
        ...
        Some(SyntaxKind::LParen) => {
            ...
            // The beauty of recursion and Pratt's algorithm is that everything contained within the parenthesis should have been parsed
